    ...
    >
      ...
      <div className="container animated-card" style={{ maxWidth: "50%" }}>
        ...
        >
          ...
          <h2 className="text-dark mb-3">Update Book</h2>
